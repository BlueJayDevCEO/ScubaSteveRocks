  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-light-card dark:bg-dark-card rounded-2xl shadow-2xl p-8 max-w-md w-full text-center animate-fade-in border border-light-accent/20 dark:border-dark-accent/20">
        <h2 className="font-heading font-bold text-3xl sm:text-4xl mb-4">Chat Limit Reached</h2>
        <p className="text-lg text-light-text/80 dark:text-dark-text/80 mb-2">
            You've used your free daily chat messages. Your limits will reset at midnight.
        </p>
        ...
        <p className="text-sm text-light-text/70 dark:text-dark-text/70 mb-6">
            Your donations help us cover server costs, which allows us to improve Scuba Steve and increase the daily chat limit for everyone.
        </p>
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            {isLoading ? 'Connecting...' : 'Upgrade to Pro ($4.99/mo) 💳'}
          </button>
           <button 
