...
const syncUserToFirestore = async (user: User) => {
    ...
    try {
        ...
        // Use merge: true to update fields without overwriting the whole doc if it exists
...
export const canUserPerformBriefing = (userId: string, type: string = 'generic'): boolean => {
    ...
    const isGuest = userId === 'mock-demo-user' || userId.startsWith('guest-') || user?.email === 'guest@scubasteve.rocks';
