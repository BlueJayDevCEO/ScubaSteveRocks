    ...
    <section id="startup" className="relative z-20 max-w-5xl mx-auto px-6 py-20">
      ...
      >
        ...
        <ul className="mt-3 list-disc pl-6 space-y-2 text-white/85">
          ...
          <li>
            Conservation-first mindset (25% of proceeds to ocean conservation)
          </li>
        </ul>
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          ...
          {/* <a
            ...
            target="_blank"
            rel="noreferrer"
            className="px-5 py-3 rounded-xl font-semibold bg-white/10 hover:bg-white/15 text-white border border-white/15 transition-colors shadow"
          >
            Watch Demo Video
          </a> */}
        </div>
